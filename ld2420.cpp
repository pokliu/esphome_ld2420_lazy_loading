...
void LD2420Component::dump_config() {
  ...
  LOG_BUTTON(TAG, "  Init Module:", this->init_module_button_);
#endif
...
void LD2420Component::setup() {
  ESP_LOGCONFIG(TAG, "Setting up LD2420 (just wating for init)...");
}

void LD2420Component::init() {
...
void LD2420Component::init_module_action() {
  ESP_LOGCONFIG(TAG, "Init LD2420 module...");
  this->init();
  ESP_LOGCONFIG(TAG, "LD2420 module init complete.");
}
